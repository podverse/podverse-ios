...
extension String {
    func formatHtmlString() -> String {
        let style = "<style>* { color: #fff !important; font-size: 14px !important; font-family: -apple-system !important; font-weight: 400; !important; } body { margin: 0 8px !important; padding: 0 !important; } a { color: #007aff !important; text-decoration: none !important; } p { margin-top: 0 !important; }</style>"
        return style + self
    }
