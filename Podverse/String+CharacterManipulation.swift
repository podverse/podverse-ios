...
extension String {
    ...
    func formatHtmlString(isWhiteBg: Bool = false) -> String {
        ...
        if isWhiteBg {
            style = "<style>* { color: #000 !important; font-size: 16px !important; font-family: -apple-system !important; font-weight: 400 !important; word-wrap: break-word !important; } body { margin: 12px !important; padding: 0 !important; } a { color: #007aff !important; text-decoration: none !important; } p { margin-top: 0 !important; } strong { font-weight: 500 !important } hr { border: none !important; height: 1px !important; color: #ccc !important; background-color: #ccc !important; } .lightGray { color: #aaa !important }</style>"
        } else {
